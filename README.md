...
```bash
git clone https://github.com/cyberhoopoeshears/qwenproxy-449.git
cd qwenproxy-449
npm install
npm start
```
...
[![CI](https://github.com/cyberhoopoeshears/qwenproxy-449/actions/workflows/ci.yml/badge.svg)](https://github.com/cyberhoopoeshears/qwenproxy-449/actions/workflows/ci.yml)
...
<!-- Last updated: 2026-06-06 15:40:35 -->
